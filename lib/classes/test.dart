...
class Beacon {
  ...
  double _calculateDistance({double pathLossExponent = 1.6}) {
...
void main() {
  final beacon1 = Beacon(
    id: 'A0:B7:65:DD:79:FE',
    name: 'Beacon 1',
    x: 0.0,
    y: 0.0,
    z: 0.0,
  ...
  final beacon2 = Beacon(
    id: 'B0:B2:1C:A7:20:86',
    name: 'Beacon 2',
    x: 10.0,
    y: 0.0,
    z: 0.0,
  ...
  final beacon3 = Beacon(
    id: 'B0:A7:32:DB:08:2E',
    name: 'Beacon 3',
    x: 5.0,
    y: 10.0,
    z: 0.0,
  ...
  try {
    final beacons = [beacon1, beacon2, beacon3];
    final result = findLocationUsingTrilateration(beacons);

    if (result != null) {
      print('Trilateration result: $result');
    } else {
      print('No valid intersection found for trilateration.');
    }
  } catch (e) {
    print('Error during trilateration: $e');
  }
}
